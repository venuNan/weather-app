    ...
    try {
        ...
        .then(data => {
            ...
            if(icon.includes("clear")){
                weathericon.style.backgroundImage = "url(/static/images/sun.png)";
            }
            else if(icon.includes("rain") && desc.includes("cloudy") && desc.includes("storm")){
                weathericon.style.backgroundImage = "url(/static/images/cloud-rain-storm.png)";
            }
            else if((icon.includes("cloudy") || desc.includes("cloudy")) && desc.includes("storm")){
                weathericon.style.backgroundImage = "url(/static/images/cloud-storm.png)";
            }
            else if(icon.includes("partly") && icon.includes("cloudy")){
                weathericon.style.backgroundImage = "url(/static/images/partly-cloudy.png)";
            }
            else if(icon.includes("cloudy")){
                weathericon.style.backgroundImage = "url(/static/images/cloudy.png)";
            }
            else if(icon.includes("rain")){
                weathericon.style.backgroundImage = "url(/static/images/cloud-rain.png)";
            }
            ...
            for (let i=0;i<10;i++){
                ...
                if(icon1.includes("clear")){
                    ...
                    symbol.style.backgroundImage = "url(/static/images/cloud-rain-storm.png)";
                }
                else if(icon1.includes("cloudy") && desc1.includes("storm")){
                    symbol.style.backgroundImage = "url(/static/images/cloud-storm.png)";
                }
                else if(icon1.includes("partly") && icon1.includes("cloudy")){
                    symbol.style.backgroundImage = "url(/static/images/partly-cloudy.png)";
                }
                else if(icon1.includes("cloudy") && desc1.includes("rain")){
                    symbol.style.backgroundImage = "url(/static/images/cloudy-rains.png)";
                }
                else if(icon1.includes("cloudy")){
                    symbol.style.backgroundImage = "url(/static/images/cloudy.png)";
                }
                else if(icon1.includes("rain")){
                    symbol.style.backgroundImage = "url(/static/images/cloud-rain.png)";
                }
            ...
            for(let i=0;i<24;i++){
                ...
                if(icon2.includes("clear") && ((datetime>=0 && datetime<=5) || (datetime>=17 && datetime<=23))){
                    document.querySelector(`.hourly-weather1 .hourly-weather .container #hour${i+1} #image`).style.backgroundImage = "url(/static/images/night.png)";
                }
                else if(icon2.includes("clear")){
                    document.querySelector(`.hourly-weather1 .hourly-weather .container #hour${i+1} #image`).style.backgroundImage = "url(/static/images/sun.png)";
                }
                else if(icon2.includes("rain") && desc2.includes("cloudy") && desc2.includes("storm")){
                    document.querySelector(`.hourly-weather1 .hourly-weather .container #hour${i+1} #image`).style.backgroundImage = "url(/static/images/cloud-rain-storm.png)";
                }
                else if(icon2.includes("cloudy") && desc2.includes("storm")){
                    document.querySelector(`.hourly-weather1 .hourly-weather .container #hour${i+1} #image`).style.backgroundImage = "url(/static/images/cloud-storm.png)";
                }
                else if(icon2.includes("partly") && icon2.includes("cloudy") && ((datetime>=0 && datetime<=5) || (datetime>=17 && datetime<=23))){
                    document.querySelector(`.hourly-weather1 .hourly-weather .container #hour${i+1} #image`).style.backgroundImage = "url(/static/images/cloud-night.png)";
                }
                else if(icon2.includes("partly") && icon2.includes("cloudy")){
                    document.querySelector(`.hourly-weather1 .hourly-weather .container #hour${i+1} #image`).style.backgroundImage = "url(/static/images/partly-cloudy.png)";
                }
                else if(icon2.includes("cloudy") && desc2.includes("rain") && ((datetime>=0 && datetime<=5) && (datetime>=19 && datetime<=23))){//
                    document.querySelector(`.hourly-weather1 .hourly-weather .container #hour${i+1} #image`).style.backgroundImage = "url(/static/images/cloudy-rainy-night.png)";
                }
                else if(icon2.includes("cloudy") && desc2.includes("rain")){
                    document.querySelector(`.hourly-weather1 .hourly-weather .container #hour${i+1} #image`).style.backgroundImage = "url(/static/images/cloudy-rains.png)";
                }
                else if(icon2.includes("cloudy")){
                    document.querySelector(`.hourly-weather1 .hourly-weather .container #hour${i+1} #image`).style.backgroundImage = "url(/static/images/cloudy.png)";
                }
                else if(icon2.includes("rain")){
                    document.querySelector(`.hourly-weather1 .hourly-weather .container #hour${i+1} #image`).style.backgroundImage = "url(/static/images/cloud-rain.png)";
                }
            }
        })
        .catch(error => {
